                    ...
                    <div className="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            <div className="p-6">
                                ...
                                <div className="ml-12">
                                    <div className="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        Laravelは、フレームワークのすべての側面をカバーする徹底したドキュメントを持っています。フレームワークに初めて触れる場合でも、Laravelに前に触れている場合でも、ドキュメントのすべてを読むことをお勧めします。
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                                ...
                                <div className="ml-12">
                                    <div className="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        チュートリアルは、Laravel、PHP、およびJavaScript開発の数千のビデオチュートリアルを提供しています。チェックしてください。
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-6 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <div className="ml-12">
                                    <div className="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        ニュースは、Laravelエコシステムの最新のニュースと重要なニュースを集約するコミュニティ駆動のポータルとニュースレターです。
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                                ...
                                <div className="ml-12">
                                    <div className="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        Laravelの堅牢なツールとライブラリのライブラリ、Forge、Vapor、Envoyer、Cashier、Dusk、Echo、Horizon、Sanctum、Telescopeなど。
                                        ,{' '}
                                        <a
